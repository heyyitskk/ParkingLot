...
public class AdminController {
    ...
    public void addSlotsToFloor(int floorNumber, Vehicle.VehicleType slotType, int count) {
        System.out.println(
                "[CONTROLLER] Admin request to add " + count + " " + slotType + " slots to floor " + floorNumber);
    ...
    public void updateHourlyPricing(Vehicle.VehicleType vehicleType, double ratePerHour) {
        System.out.println(
                "[CONTROLLER] Admin request to update hourly pricing for " + vehicleType + " to " + ratePerHour);
